<template>
  <div class="container">
    ...
    <a-tabs v-model:activeKey="activeKey" @change="handleChange">
      <a-tab-pane v-for="(tabsItem, tabsIndex) in tabsList" :key="tabsItem.key" :tab="tabsItem.tab" class="tabPane">
        <div class="change" v-for="(change, changeIdx) in tabsItem.changeList" :key="changeIdx + 1">
          <h1>{{ change.h1 }}</h1>
          <h4>{{ change.h4 }}</h4>
          <a-row :gutter="30">
        ...
        <!-- 额外的 -->
        <div class="change" v-for="(solutionTwo, solutionTwoIdx) in tabsItem.solutionListTwo" :key="solutionTwoIdx + 3">
          <h1>{{ solutionTwo.h1 }}</h1>
          <h4>{{ solutionTwo.h4 }}</h4>
          <a-row :gutter="[30, 30]">
            <a-col :span="solutionItemTwo.span" v-for="(
                solutionItemTwo, solutionIndexTwo
              ) in solutionTwo.solutionListSonTwo" :key="solutionIndexTwo + 4">
              <div class="solutionCardTwo">
                <img :src="solutionItemTwo.img" style="width: 60px; margin: 25px 0 15px" />
        ...
        <!-- 解决方法 -->
        <div class="change" v-for="(solution, solutionIdx) in tabsItem.solutionList" :key="solutionIdx + 5">
          <h1>{{ solution.h1 }}</h1>
          <h4>{{ solution.h4 }}</h4>
          <a-row :gutter="[30, 30]">
            <a-col :span="solutionItem.span" v-for="(solutionItem, solutionIndex) in solution.solutionListSon"
              :key="solutionIndex + 6">
        ...
        <!-- 展陈 -->
        <div class="change" v-for="(solutionThree, solutionThreeIdx) in tabsItem.solutionListThree"
          :key="solutionThreeIdx + 7">
          <h1>{{ solutionThree.h1 }}</h1>
          <h4>{{ solutionThree.h4 }}</h4>
          <a-row :gutter="[30, 30]">
            <a-col :span="solutionItemThree.span" v-for="(
                solutionItemThree, solutionIndex
              ) in solutionThree.solutionListSonThree" :key="solutionIndex + 8">
              <div class="solutionCardThree">
                <img :src="solutionItemThree.img" style="width: 60px; margin: 25px 0 15px" />
        ...
        <!-- 效果和收益 -->
        <div class="change" v-for="(effects, effectsIdx) in tabsItem.effectsList" :key="effectsIdx + 9">
          <h1>{{ effects.h1 }}</h1>
          <h4>{{ effects.h4 }}</h4>
          <a-row :gutter="30">
            <a-col :span="effectsItem.span" v-for="(effectsItem, effectsIndex) in effects.effectsListSon"
              :key="effectsIndex + 10">
              <div class="effectsCard">
                <div class="effectsData">
                  <div class="value">{{ effectsItem.title }}</div>
